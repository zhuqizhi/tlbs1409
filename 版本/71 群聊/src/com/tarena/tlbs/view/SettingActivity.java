...
public class SettingActivity extends BaseActivity {
	...
	Menu menu;
	Button btnGroupChat,btnExit, btnUpdate, btnAbout, btnRecommend;
	...
	private void addListener() {
		btnGroupChat.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				try {
					startActivity(new Intent(SettingActivity.this,InputRoomActivity.class));
				} catch (Exception e) {
					// TODO: handle exception
				}
			}
		...
		btnRecommend.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					// 显示积分墙，显示在一个新的activity中，activity在jar
					// youmi sdk 有一个activity,.xml,联网，解析，显示
					AdManager.getInstance(SettingActivity.this).init(
							"4648c5afc044b64e", "d73d40f04826354b", false);
					// 如果使用积分广告，请务必调用积分广告的初始化接口:
					OffersManager.getInstance(SettingActivity.this)
							.onAppLaunch();
					OffersManager.getInstance(SettingActivity.this)
							.showOffersWall();
				} catch (Exception e) {
	...
	private void setupView() {
		...
		btnRecommend = (Button) findViewById(R.id.btn_setting_recommend);
		btnGroupChat = (Button) findViewById(R.id.btn_setting_groupChat);
	}
