...
public class MyFreindAdapter extends BaseExpandableListAdapter {
	...
	public void updateData(ArrayList<RosterGroup> listGroup) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		// 得数据
		RosterEntry rosterEntry = (RosterEntry) this.getChild(groupPosition,
				childPosition);
		String friendName = rosterEntry.getName();
		// 给控件设值
		TextView tvFriendName = (TextView) view
				.findViewById(R.id.tv_my_friend_group_friendName);
